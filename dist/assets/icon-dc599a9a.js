import{aP as l,cP as h,cu as e,cQ as o,cR as n,cS as p,cT as f,cU as m,cV as t,cW as d,cX as v,ca as F,cY as u,cZ as E,c_ as M,c$ as H,d0 as I,d1 as B,d2 as V,d3 as A}from"./index-b4bec724.js";import{h as k}from"./index-6be0c2ff.js";import{I as x}from"./Layout-51f52032.js";import{a as D}from"./index-462bfcfc.js";var c=(a=>(a[a.UNKNOWN=0]="UNKNOWN",a[a.FOLDER=1]="FOLDER",a[a.VIDEO=2]="VIDEO",a[a.AUDIO=3]="AUDIO",a[a.TEXT=4]="TEXT",a[a.IMAGE=5]="IMAGE",a))(c||{});function L(a){return l({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#070444"
  ...
  ></path>F`},a)}function g(a){return l({a:{viewBox:"0 0 48 48"},c:`<path d="M0 0h48v48H0z" fill="none"/>
      <path fill="#ffffff" d="M40 8H8c-2.21 0-4 1.79-4 4v24c0 2.21 1.79 4 4 4h32c2.21 0 4-1.79 4-4V12c0-2.21-1.79-4-4-4zM8 24h8v4H8v-4zm20 12H8v-4h20v4zm12 0h-8v-4h8v4zm0-8H20v-4h20v4z"/>`},a)}const z={"dmg,ipa,plist,tipa":d,"exe,msi":v,apk:x,db:F,md:u,epub:E,iso:M,m3u8:t,"doc,docx":H,"xls,xlsx":I,"ppt,pptx":B,pdf:V,psd:L,ai:Z,url:A,cast:D},S=(a,i)=>{if(a!==c.FOLDER){for(const[s,r]of Object.entries(z))if(s.split(",").includes(h(i).toLowerCase()))return r;if(e(i))return o}switch(a){case c.FOLDER:return k;case c.VIDEO:return t;case c.AUDIO:return m;case c.TEXT:return f;case c.IMAGE:return p;default:return n}},R=a=>S(a.type,a.name);export{g as A,c as O,R as g};
