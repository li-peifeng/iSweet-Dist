import{aF as l,cG as h,cl as e,cH as o,cI as n,cJ as p,cK as f,cL as m,cM as t,cN as d,cO as F,c0 as v,cP as M,cQ as u,cR as E,cS as H,cT as I,cU as B,cV as V,cW as A}from"./index-8f978961.js";import{h as k}from"./index-01fdd55f.js";import{I as x}from"./Layout-3e0c783f.js";import{a as L}from"./index-c5d90ce5.js";var c=(a=>(a[a.UNKNOWN=0]="UNKNOWN",a[a.FOLDER=1]="FOLDER",a[a.VIDEO=2]="VIDEO",a[a.AUDIO=3]="AUDIO",a[a.TEXT=4]="TEXT",a[a.IMAGE=5]="IMAGE",a))(c||{});function D(a){return l({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#070444"
  ...
  ></path>F`},a)}function g(a){return l({a:{viewBox:"0 0 48 48"},c:`<path d="M0 0h48v48H0z" fill="none"/>
      <path fill="#ffffff" d="M40 8H8c-2.21 0-4 1.79-4 4v24c0 2.21 1.79 4 4 4h32c2.21 0 4-1.79 4-4V12c0-2.21-1.79-4-4-4zM8 24h8v4H8v-4zm20 12H8v-4h20v4zm12 0h-8v-4h8v4zm0-8H20v-4h20v4z"/>`},a)}const z={"dmg,ipa,plist,tipa":d,"exe,msi":F,apk:x,db:v,md:M,epub:u,iso:E,m3u8:t,"doc,docx":H,"xls,xlsx":I,"ppt,pptx":B,pdf:V,psd:D,ai:Z,url:A,cast:L},N=(a,i)=>{if(a!==c.FOLDER){for(const[s,r]of Object.entries(z))if(s.split(",").includes(h(i).toLowerCase()))return r;if(e(i))return o}switch(a){case c.FOLDER:return k;case c.VIDEO:return t;case c.AUDIO:return m;case c.TEXT:return f;case c.IMAGE:return p;default:return n}},O=a=>N(a.type,a.name);export{g as A,c as O,O as g};
