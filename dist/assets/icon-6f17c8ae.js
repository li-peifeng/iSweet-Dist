import{aP as l,cQ as h,cv as e,cR as o,cS as n,cT as p,cU as d,cV as f,cW as t,cX as m,cY as v,ca as F,cZ as u,c_ as E,c$ as M,d0 as H,d1 as I,d2 as B,d3 as V,d4 as A}from"./index-af74a726.js";import{h as k}from"./index-c4ec7100.js";import{I as x}from"./Layout-5c159d08.js";import{a as D}from"./index-7b2443b1.js";var c=(a=>(a[a.UNKNOWN=0]="UNKNOWN",a[a.FOLDER=1]="FOLDER",a[a.VIDEO=2]="VIDEO",a[a.AUDIO=3]="AUDIO",a[a.TEXT=4]="TEXT",a[a.IMAGE=5]="IMAGE",a))(c||{});function L(a){return l({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#070444"
  ...
  ></path>F`},a)}function g(a){return l({a:{viewBox:"0 0 48 48"},c:`<path d="M0 0h48v48H0z" fill="none"/>
      <path fill="#ffffff" d="M40 8H8c-2.21 0-4 1.79-4 4v24c0 2.21 1.79 4 4 4h32c2.21 0 4-1.79 4-4V12c0-2.21-1.79-4-4-4zM8 24h8v4H8v-4zm20 12H8v-4h20v4zm12 0h-8v-4h8v4zm0-8H20v-4h20v4z"/>`},a)}const z={"dmg,ipa,plist,tipa":m,"exe,msi":v,apk:x,db:F,md:u,epub:E,iso:M,m3u8:t,"doc,docx":H,"xls,xlsx":I,"ppt,pptx":B,pdf:V,psd:L,ai:Z,url:A,cast:D},S=(a,i)=>{if(a!==c.FOLDER){for(const[s,r]of Object.entries(z))if(s.split(",").includes(h(i).toLowerCase()))return r;if(e(i))return o}switch(a){case c.FOLDER:return k;case c.VIDEO:return t;case c.AUDIO:return f;case c.TEXT:return d;case c.IMAGE:return p;default:return n}},R=a=>S(a.type,a.name);export{g as A,c as O,R as g};
