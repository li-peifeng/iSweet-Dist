import{aD as l,cx as h,cy as e,cz as o,cA as n,cB as p,cC as f,cD as m,cE as t,cF as d,cG as F,c4 as v,cH as E,cI as u,cJ as M,cK as H,cL as I,cM as B,cN as V,cO as A}from"./index.a11aeb8c.js";import{h as x}from"./index.6e1a3a15.js";import{I as k}from"./Layout.8e7eca15.js";import{a as D}from"./index.5293bb8d.js";var c=(a=>(a[a.UNKNOWN=0]="UNKNOWN",a[a.FOLDER=1]="FOLDER",a[a.VIDEO=2]="VIDEO",a[a.AUDIO=3]="AUDIO",a[a.TEXT=4]="TEXT",a[a.IMAGE=5]="IMAGE",a))(c||{});function L(a){return l({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#070444"
  ...
  ></path>F`},a)}function P(a){return l({a:{viewBox:"0 0 48 48"},c:`<path d="M0 0h48v48H0z" fill="none"/>
      <path fill="#ffffff" d="M40 8H8c-2.21 0-4 1.79-4 4v24c0 2.21 1.79 4 4 4h32c2.21 0 4-1.79 4-4V12c0-2.21-1.79-4-4-4zM8 24h8v4H8v-4zm20 12H8v-4h20v4zm12 0h-8v-4h8v4zm0-8H20v-4h20v4z"/>`},a)}const z={"dmg,ipa,plist,tipa":d,"exe,msi":F,apk:k,db:v,md:E,epub:u,iso:M,m3u8:t,"doc,docx":H,"xls,xlsx":I,"ppt,pptx":B,pdf:V,psd:L,ai:Z,url:A,cast:D},w=(a,i)=>{if(a!==c.FOLDER){for(const[s,r]of Object.entries(z))if(s.split(",").includes(i.toLowerCase()))return r;if(e().includes(i))return o}switch(a){case c.FOLDER:return x;case c.VIDEO:return t;case c.AUDIO:return m;case c.TEXT:return f;case c.IMAGE:return p;default:return n}},U=a=>w(a.type,h(a.name));export{P as A,c as O,U as g};
