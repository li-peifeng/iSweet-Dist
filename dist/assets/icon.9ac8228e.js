import{aF as l,cB as h,ct as e,cC as o,cD as n,cE as p,cF as f,cG as m,cH as t,cI as d,cJ as F,ca as v,cK as E,cL as M,cM as u,cN as H,cO as I,cP as B,cQ as V,cR as A}from"./index.40a931c6.js";import{h as k}from"./index.7fa10a04.js";import{I as x}from"./Layout.ea92c880.js";import{a as D}from"./index.1b03736d.js";var c=(a=>(a[a.UNKNOWN=0]="UNKNOWN",a[a.FOLDER=1]="FOLDER",a[a.VIDEO=2]="VIDEO",a[a.AUDIO=3]="AUDIO",a[a.TEXT=4]="TEXT",a[a.IMAGE=5]="IMAGE",a))(c||{});function L(a){return l({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#070444"
  ...
  ></path>F`},a)}function O(a){return l({a:{viewBox:"0 0 48 48"},c:`<path d="M0 0h48v48H0z" fill="none"/>
      <path fill="#ffffff" d="M40 8H8c-2.21 0-4 1.79-4 4v24c0 2.21 1.79 4 4 4h32c2.21 0 4-1.79 4-4V12c0-2.21-1.79-4-4-4zM8 24h8v4H8v-4zm20 12H8v-4h20v4zm12 0h-8v-4h8v4zm0-8H20v-4h20v4z"/>`},a)}const z={"dmg,ipa,plist,tipa":d,"exe,msi":F,apk:x,db:v,md:E,epub:M,iso:u,m3u8:t,"doc,docx":H,"xls,xlsx":I,"ppt,pptx":B,pdf:V,psd:L,ai:Z,url:A,cast:D},N=(a,i)=>{if(a!==c.FOLDER){for(const[s,r]of Object.entries(z))if(s.split(",").includes(h(i).toLowerCase()))return r;if(e(i))return o}switch(a){case c.FOLDER:return k;case c.VIDEO:return t;case c.AUDIO:return m;case c.TEXT:return f;case c.IMAGE:return p;default:return n}},R=a=>N(a.type,a.name);export{O as A,c as O,R as g};
